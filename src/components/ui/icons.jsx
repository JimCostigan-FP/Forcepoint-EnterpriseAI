...
/* Events page icons */
export const VideoIcon      = I(<><rect x="3" y="6" width="13" height="12" rx="2"/><path d="m21 8-5 4 5 4Z"/></>)
export const MapPinIcon     = I(<><path d="M12 22s7-7.5 7-13a7 7 0 1 0-14 0c0 5.5 7 13 7 13Z"/><circle cx="12" cy="9" r="2.5"/></>)
export const ClockIcon      = I(<><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3.5 2"/></>)
export const ChevronLeft    = I(<path d="m15 6-6 6 6 6"/>)
export const ExternalLinkIcon = I(<><path d="M14 4h6v6"/><path d="M10 14 20 4"/><path d="M19 14v5a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h5"/></>)
export const UsersIcon      = I(<><circle cx="9" cy="8" r="3.2"/><path d="M2.5 20a6.5 6.5 0 0 1 13 0"/><path d="M17 11a3 3 0 1 0 0-6"/><path d="M22 19a5 5 0 0 0-5-5"/></>)
